	...
	case FL_DRAG: // if the user drags the mouse
	{
		...
		if (selected >= 0 && m_pressedMouseButton == 1) {
			...
			mousePoleGo(r1x, r1y, r1z, r2x, r2y, r2z,
				static_cast<double>(m_mover->m_particle->getPosition().x),
				static_cast<double>(m_mover->m_particle->getPosition().y),
				static_cast<double>(m_mover->m_particle->getPosition().z),
				rx, ry, rz,
